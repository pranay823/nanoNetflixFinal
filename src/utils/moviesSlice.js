...
export const  {addNowPlayingMovies , addMovieTrailer , addPopularMovies,addTopRatedMovies,addUpcomingMovies , addMovieDetails, toggleshowMovieDetailPage , addindividualMovieTrailer } = moviesSlice.actions;
